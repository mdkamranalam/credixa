    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              <img src="/credixa-favicon.png" alt="Credixa Logo" className="w-10 h-10 rounded-xl object-contain shadow-sm" />
      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#F0FDF4] via-white to-white"></div>
          {/* Decorative blurred shapes */}
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#D1FAE5] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F0FDF4] border border-[#A7F3D0] text-slate-800 font-medium text-sm mb-8 shadow-sm">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#D1FAE5] flex items-center justify-center text-emerald-500 font-bold">1</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#D1FAE5] flex items-center justify-center text-emerald-500 font-bold">2</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#D1FAE5] flex items-center justify-center text-emerald-500 font-bold">3</div>
                  <div>
              ...
              <div className="bg-gradient-to-tr from-emerald-500 to-indigo-600 p-1 rounded-2xl shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500">
                <div className="bg-white rounded-xl p-8 h-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="py-4">
                      <div className="h-24 bg-[#F0FDF4] rounded-lg flex items-center justify-center border border-[#A7F3D0]">
      ...
      <div className="bg-emerald-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 text-center">
          ...
          <Link
            to="/register/student"
            className="inline-flex items-center gap-2 px-8 py-4 text-lg font-bold rounded-full text-emerald-500 bg-white hover:bg-gray-50 shadow-lg hover:shadow-xl transition-all"
          >
      ...
      <footer className="bg-gray-900 border-t border-gray-800 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              <img src="/credixa-favicon.png" alt="Credixa Logo" className="h-8 w-8 rounded-lg object-contain" />
