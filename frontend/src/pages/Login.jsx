          ...
          {viewMode === "LOGIN" && (
            <form className="space-y-6" onSubmit={handleLoginSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-emerald-500 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 active:scale-[0.98] transition-all"
              >
