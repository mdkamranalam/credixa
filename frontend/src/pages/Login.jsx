...
const Login = () => {
  ...
  const renderSubtext = () => {
    ...
    if (viewMode === "RESET") return "Submit your new password if approved.";
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100">
          ...
          {viewMode === "LOGIN" && (
            <div className="mt-6 text-center space-y-2">
              ...
              <button type="button" onClick={() => { setViewMode("RESET"); setError(""); setSuccess(""); }} className="text-xs text-gray-400 hover:text-gray-600">
